...
<template slot="content">
  ...
  <div>
    <risk-pie-chart v-if="loaded" :chart-data="chartDataDay" :options="optionsDay">
      ></risk-pie-chart>
  </div>
</template>
...
<template slot="content">
  ...
  <risk-pie-chart v-if="loaded" :chart-data="chartDataWeek" :options="optionsWeek">
    ></risk-pie-chart>
</template>
...
<template slot="content">
  ...
  <risk-pie-chart v-if="loaded" :chart-data="chartDataMonth" :options="optionsMonth">
    ></risk-pie-chart>
</template>
...
<script>
  ...
  export default {
    ...
    computed: mapState({
      riskUpdate: state => state.journal.riskData.riskUpdateNeeded
    }),
    ...
    watch: {
      riskUpdate: function() {
        ...
        if (this.riskData.riskUpdateNeeded) {
          this.getData();
        }
    ...
    methods: {
      ...
      getData() {
        this.riskData = this.$store.state.journal.riskData;
        this.riskData.riskUpdateNeeded = false;
