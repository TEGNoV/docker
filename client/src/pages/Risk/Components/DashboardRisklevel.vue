<template>
  <div>
    <v-card>
      <v-card-title class="justify-center"> Risk Levels</v-card-title>
      <v-card-text class="text-center">
        <v-row dense justify="center">
          ...
          <v-col cols="12" sm="6" xs="6">
            R1 ({{ Number(this.$store.state.global.risk.r1) / 1 }}%):
          </v-col>
          <v-col cols="12" sm="6" xs="6" dense>
            {{ r1 }}
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            R2 ({{ Number(this.$store.state.global.risk.r2) / 1 }}%):
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            {{ r2 }}
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            R3 ({{ Number(this.$store.state.global.risk.r3) / 1 }}%):
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            {{ r3 }}
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            R4 ({{ Number(this.$store.state.global.risk.r4) / 1 }}%):
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            {{ r4 }}
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            R5 ({{ Number(this.$store.state.global.risk.r5) / 1 }}%):
          </v-col>
          <v-col cols="12" sm="6" xs="6">
            {{ r5 }}
          </v-col>
